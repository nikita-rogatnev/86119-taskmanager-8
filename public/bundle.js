              ...
              <div class="card__dates">
                ...
                <fieldset class="card__date-deadline" ${!this._state.isDate && `disabled`}>
                  <label class="card__input-deadline-wrap">
                    <input class="card__date" type="text" placeholder="23 September" name="date" value="${moment__WEBPACK_IMPORTED_MODULE_2___default()(this._dueDate).format(`DD MMMM HH:MM`)}" />
                  </label>
                  <label class="card__input-deadline-wrap">
